...
/*
  Extra area for code parts which are now unused or depreciated with updates or newer algorithms/Methods
*/

//NO LONGER USED WAS AT LINE 125 This was the original primitive method of gauging help for the purpose of the prototype demo
...
switch (switchArg) {
  ...
  //Was at line 284 for testing guild ID
  ...
  //Was at line 97
  //Gets IDs for both channel headings to create channels later (No Longer Used)
/*  message.guild.channels.cache.forEach((val, inx) =>{
    const channelName = val.name;
